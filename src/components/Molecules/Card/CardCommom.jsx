  ...
  <CardCustomize>
    <div className="p-2.5">
      ...
      <div className="flex items-center">
        <Rate
          allowHalf
          defaultValue={valueDefaultRate}
          className={`${classRate} text-yellow-400`}
        />
...
CardCommom.defaultProps = {
  srcImg:
    'https://baoquocte.vn/stores/news_dataimages/dangtuan/082019/16/08/in_article/cuoc-choi-song-con.jpg',
  title:
    'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Adipisci in dolores et minus praesentium',
